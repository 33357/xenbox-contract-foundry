...
import { IXenClient, XenModel } from '..';

export class XenClient implements IXenClient {
  protected _contract: Contract;
  protected _provider: Provider | Signer;
  protected _waitConfirmations = 1;
  protected _errorTitle = 'XenBoxHelperClient';

  constructor(provider: Provider | Signer, waitConfirmations?: number) {
  ...
  public async userMints(
    user: string,
    config?: CallOverrides
  ): Promise<XenModel.MintInfo> {
    return this._contract.userMints(user, { ...config });
  }

  public async globalRank(config?: CallOverrides): Promise<BigNumber> {
    return this._contract.globalRank({ ...config });
  }

  /* ================ TRANSACTION FUNCTIONS ================ */
}

const address = '0x06450dEe7FD2Fb8E39061434BAbCFC05599a6Fb8';
